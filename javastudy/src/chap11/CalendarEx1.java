...
/*
 * Calendar 클래스 : 추상클래스(객체화불가) new Calendar() 으로 객체화불가
...
public class CalendarEx1 {
	public static void main(String[] args) {
		...
		System.out.println("년도기준몇째주:" + now.get(Calendar.WEEK_OF_YEAR));
		...
		System.out.println("년기준일자:" + now.get(Calendar.DAY_OF_YEAR));
		...
		System.out.println
		("TimeZone(밀리초=>시간):" + now.get(Calendar.ZONE_OFFSET)/(1000*60*60));
		System.out.println
		("이번달의 마지막일자:" + now.getActualMaximum(Calendar.DATE));
